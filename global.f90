...
real                 :: Fex, Fs, Fsp, Fs2p, Fs3p, Fo, Fop, Fo2p !used in fluxCorrect in timestep module
...
integer              ::procno=3    !processor number for print statements, 0 is inner boundary
